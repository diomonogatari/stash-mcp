...
{
    [McpServerTool(Name = "list_projects", ReadOnly = true, Title = "List Projects"), Description("Lists all projects in the Bitbucket Server instance. Results may be scoped to the user's active projects based on BITBUCKET_PROJECTS or recent repository activity.")]
